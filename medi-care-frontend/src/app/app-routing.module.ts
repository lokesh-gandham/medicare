...
const routes: Routes = [
  ...
  { path: 'admin/add-medicine', component: AddProductComponent, canActivate: [AdminGuardService], pathMatch: 'full', title: 'Add Medicine' },
  { path: 'admin/get/all/medicines', component: ShowAllProductsComponent, canActivate: [AdminGuardService], pathMatch: 'full', title: 'All Medicines' },
  { path: 'admin/update/medicine/:pid', component: UpdateProductComponent, canActivate: [AdminGuardService], pathMatch: 'full', title: 'Update Medicine' },
