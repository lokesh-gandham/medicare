...
public class ShowUpdateTest {
	 ...
	 @Test
		public  void ShowUpdate() throws InterruptedException {
			...
			Thread.sleep(1000L);
			WebElement Element=driver.findElement(By.id("allmedicines"));
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].scrollIntoView();", Element);
			driver.findElement(By.id("allmedicines")).click();
			Thread.sleep(1000L);
			...
			Element1.clear();
			driver.findElement(By.name("price")).sendKeys("15");
			Thread.sleep(1000L);
			driver.findElement(By.name("update")).click();
			driver.findElement(By.name("close")).click();
			Thread.sleep(1000L);
			driver.get("http://localhost:4200/admin/get/all/medicines");
			assertEquals(driver.getCurrentUrl(), "http://localhost:4200/admin/get/all/medicines");
